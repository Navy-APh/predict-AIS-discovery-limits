...
save_path_test =  '/content/drive/MyDrive/Colab Notebooks/Results/LSTM_Meteo_X_test_results_comparison.csv'
save_path_train = '/content/drive/MyDrive/Colab Notebooks/Results/LSTM_Meteo_X_train_results_comparison.csv'
