...
model.add(LSTM(512, input_shape = (input_neurons,1), return_sequences=True))
...
model.fit(X_train, y_train, epochs=200, batch_size=8, validation_data=(X_test, y_test), callbacks=[lr_callback], shuffle=False)
...
save_path_test =  '/content/drive/MyDrive/Colab Notebooks/Results/LSTM_Prop_X_test_results_comparison.csv'
save_path_train = '/content/drive/MyDrive/Colab Notebooks/Results/LSTM_Prop_X_train_results_comparison.csv'
