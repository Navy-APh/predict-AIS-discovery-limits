...
for i in range(len(dataset1_train) - rec - pred + 1):
    X_train.append(dataset1_train[i:i+rec, 1:9].reshape(1, -1))
...
for i in range(len(dataset2_test) - rec - pred + 1):
    X_test.append(dataset2_test[i:i+rec, 1:9].reshape(1, -1))
...
save_path_test =  '/content/drive/MyDrive/Colab Notebooks/Results/Simple_Meteo_X_test_results_comparison.csv'
save_path_train = '/content/drive/MyDrive/Colab Notebooks/Results/Simple_Meteo_X_train_results_comparison.csv'
